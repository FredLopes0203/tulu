...
@section ('title', 'Alert Management' . ' | ' . 'Dismiss Alert')
...
@section('page-header')
    <h1>
        Alert Management
        <small>Dismiss Alert</small>
    </h1>
@endsection

@section('content')
        {{ Form::open(['route' => 'admin.alert.curalert.destroy', 'id' => 'alertcreateform', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
