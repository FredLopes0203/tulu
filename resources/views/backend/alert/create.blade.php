...
@section ('title', 'Alert Management' . ' | ' . 'Create Alert')
...
@section('content')
        {{ Form::open(['route' => 'admin.alert.curalert.newalert', 'id' => 'alertcreateform', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <div style="display: inline-table; margin-bottom: 15px">{{ Form::checkbox('push', '1', true, array('disabled')) }}<b style="margin-left: 10px; margin-right: 25px;">Push</b></div>
                        <div style="display: inline-table; margin-bottom: 15px">{{ Form::checkbox('text', '1', false) }}<b style="margin-left: 10px; margin-right: 25px;">Text</b></div>
                        <div style="display: inline-table; margin-bottom: 15px">{{ Form::checkbox('email', '1', false) }}<b style="margin-left: 10px; margin-right: 25px;">Email</b></div>
                        <div style="display: inline-table; margin-bottom: 15px">{{ Form::checkbox('response', '1', false) }}<b style="margin-left: 10px">Require OK/NOT OK Responses</b></div>
                    </div><!--col-lg-10-->
                </div>
