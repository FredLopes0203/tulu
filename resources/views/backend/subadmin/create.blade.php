...
@section ('title', 'Subadmin Management' . ' | ' . 'Create Subadmin')
...
@section('content')
        {{ Form::open(['route' => 'admin.subadmin.store', 'id' => 'subadmincreateform', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('firstname', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Subadmin First Name']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('lastname', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Subadmin Last Name']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('email', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Subadmin Email']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group" style="margin-top:50px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="pull-left">
                            {{ link_to_route('admin.subadmin.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md', 'style' => 'width:100px !important;']) }}
                        </div><!--pull-left-->
                    </div><!--col-lg-10-->
                </div><!--form control-->
            </div><!-- /.box-body -->
...
@section('after-scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#subadmincreateform").submit(function(evt){
                if(imageData == "")
                {
                    swal({
                ...
                $("#subadmincreateform").append(imgInput);
